...
const DEFAULT_INPUTS: Record<Platform, PlatformInputs> = {
  linkedin: {
    targetAudience: 'Seed Company Executives',
    problem: 'coating-inconsistency',
    angle: 'Hidden Cost Leak',
    tone: 'professional',
    objective: 'Build Authority',
    contentFormat: 'post',
  } as LinkedInInputs,
  youtube: {
    targetAudience: 'Seed Production Managers',
    problem: 'germination-variability',
    angle: 'Agronomic Performance Breakdown',
    tone: 'direct',
  ...
  instagram: {
    targetAudience: 'Growers',
    problem: 'planting-performance-risk',
    angle: 'Before/After Improvement',
    tone: 'direct',
    objective: 'Build Authority',
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-semibold text-lg" style={{ color: BRAND_COLOR }}>Seed Coating</span>
                </div>
          ...
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                ...
                border: `1px solid ${BRAND_COLOR}4D`,
              }}
            >
              <span className="text-xs font-semibold tracking-wide uppercase" style={{ color: BRAND_COLOR }}>
                Content Engine
              </span>
            </div>
          </div>
