...
const DEFAULT_INPUTS: Record<Platform, PlatformInputs> = {
  ...
  youtube: {
    ...
    problem: 'device-wiping-assumptions',
  ...
  twitter: {
    ...
    problem: 'chain-of-custody-failures',
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-semibold text-lg" style={{ color: BRAND_COLOR }}>ITAD</span>
                </div>
